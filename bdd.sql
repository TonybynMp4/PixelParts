DROP DATABASE IF EXISTS `pixelparts`;
...
INSERT INTO
    `category` (`name`, `subtitle`, `picture`, `show_home`)
VALUES
    (
        'Carte Graphique',
    ...
    (
        'Alimentation',
        'Les meilleures alimentations',
        'alimentation.jpg',
        1
    ),
    (
        'Boitier',
        'Les meilleurs boitiers',
        'boitier.jpg',
        1
    ),
    (
        'Ventirad',
        'Les meilleurs ventirads',
        'ventirad.jpg',
        1
    ),
    (
        'Watercooling',
        'Les meilleurs watercooling',
        'watercooling.jpg',
        1
    );
...
VALUES
    ...
    (
        'Core i9-14900KS',
        'Processeur Intel Core i9-14900KS',
        'i9_14900ks.jpg',
        599.99,
        4.7,
        1,
    ...
    (
        ...
        'Carte Graphique RTX 4060 de la marque Gigabyte',
        'rtx4060_windforce_oc.jpg',
        329.99,
        4.6,
        1,
        1,
    ...
    (
        'RTX 4070 Ti SUPER',
        'Carte Graphique RTX 4070 Ti SUPER de la marque MSI ',
        'msi_4070tisuper.jpg',
        1129.99,
        4.7,
        1,
